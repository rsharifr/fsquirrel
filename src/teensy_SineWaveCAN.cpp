...
void loop() {
  ...
  if (t<rampDuration){
    ...
    // Serial.print(rampDuration-t); Serial.print("  "); 
    // Serial.print(feedback1.Pos_Estimate*(rampDuration-t)/rampDuration); Serial.print("  ");
    // Serial.println(feedback1.Pos_Estimate);
    // delay(10);
  ...
  if (odrv1_user_data.received_feedback) {
    ...
    // Serial.print("odrv1-pos:"); Serial.print(feedback1.Pos_Estimate); Serial.print(","); Serial.print("odrv1-vel:"); Serial.println(feedback1.Vel_Estimate); 
  }

  if (odrv2_user_data.received_feedback) {
    feedback2 = odrv2_user_data.last_feedback;
    odrv2_user_data.received_feedback = false;
    // Serial.print("odrv2-pos:"); Serial.print(feedback2.Pos_Estimate); Serial.print(","); Serial.print("odrv2-vel:"); Serial.println(feedback2.Vel_Estimate); 
  }

  if (odrv3_user_data.received_feedback) {
    feedback3 = odrv3_user_data.last_feedback;
    odrv3_user_data.received_feedback = false;
    // Serial.print("odrv3-pos:"); Serial.print(feedback3.Pos_Estimate); Serial.print(","); Serial.print("odrv3-vel:"); Serial.println(feedback3.Vel_Estimate); 
  }

  if (odrv4_user_data.received_feedback) {
    feedback4 = odrv4_user_data.last_feedback;
    odrv4_user_data.received_feedback = false;
    // Serial.print("odrv4-pos:"); Serial.print(feedback4.Pos_Estimate); Serial.print(","); Serial.print("odrv4-vel:"); Serial.println(feedback4.Vel_Estimate); 
  }
  ...
  // odrv1.getError(err1, 10);
  // Serial.println(err1.Active_Errors);
